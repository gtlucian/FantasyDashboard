...
SPECIAL_PROFILES = {
    "alvin kamara": {
        ...
        "action_advice": "Suffered an MCL sprain during joint practice with the Dallas Cowboys; expected to miss at least a month into the regular season. At xrank #151 / ADP #158.2, Kendre Miller provides superior standalone upside in New Orleans."
    },
    "jayden higgins": {
        ...
        "action_advice": "Suffered a season-ending torn ACL during joint scrimmage with the Raiders on Aug 18. Completely off redraft boards. Solidifies alpha target volume for Nico Collins (xrank #15) and Tank Dell in Houston."
    },
    "ricky pearsall": {
    ...
    "chuba hubbard": {
        ...
        "action_advice": "Sidelined week-to-week with a hamstring strain suffered in practice. Conceded starting 1st-team reps to Jonathon Brooks (xrank #88 / ADP #91.2), who is taking command of the Carolina backfield."
    },
    "luther burden": {
    ...
    "jordyn tyson": {
        ...
        "action_advice": "Dealing with recurring hamstring issues in New Orleans that could cost him regular season time. Funnels heavy early-season target share to Chris Olave (xrank #25 / ADP #26.1)."
    },
    "malik nabers": {
        ...
        "action_advice": "Avoided the PUP list and progressing smoothly in full 11-on-11 team contact drills. Commanded 31%+ camp target share in New York. Priority Round 3 smash target (xrank #27 / ADP #28.2)."
    },
    "jonathon brooks": {
        ...
        "action_tag": "SMASH TARGET (R8)",
        "action_advice": "Taking command of starting offensive snaps in Carolina with Hubbard sidelined by a hamstring strain. Clear bellcow path in Dave Canales' offense. Priority Round 7/8 target (xrank #88 / ADP #91.2)."
    },
    "puka nacua": {
        ...
        "action_advice": "Brief practice absence was purely precautionary; returning to full team action with zero structural issues. Sean McVay confirmed 100% Week 1 readiness in Los Angeles alongside Davante Adams. Smash at xrank #4 / ADP #4.5."
    },
    "josh jacobs": {
        ...
        "action_advice": "Returned to practice August 18 in Green Bay after missing time with an injury (xrank #36 / ADP #36.6). Draft MarShawn Lloyd in Round 11-12 as non-negotiable insurance."
    },
    "tyler warren": {
        ...
        "action_advice": "Groin strain suffered on Aug 19 is confirmed minor; will not impact Week 1 availability. High target floor in Indianapolis (xrank #63 / ADP #61.1)."
    },
    "emeka egbuka": {
        ...
        "action_advice": "Toe sprain is confirmed stable and not expected to linger. Operating in 3-WR sets with Baker Mayfield and Chris Godwin Jr. in Tampa Bay (xrank #38 / ADP #38.2)."
    },
    "makai lemon": {
        ...
        "action_advice": "Returned to practice on Aug 20 after resolving a hamstring tweak. High-upside depth piece in Philadelphia with Jalen Hurts (xrank #106 / ADP #108.4)."
    },
    "patrick mahomes": {
        ...
        "action_advice": "Full scrimmage participant with Rashee Rice, Xavier Worthy, and Travis Kelce in Kansas City. Preseason rest is veteran preservation. Draft at xrank #98 / ADP #99.1."
    },
    "bo nix": {
        ...
        "action_advice": "Starting preseason action with postseason ankle completely healed. Locked in as Sean Payton's starting quarterback in Denver (xrank #100 / ADP #99.6)."
    }
}
...
def analyze_injury_draft_strategy(
    ...
    for p in top_200:
        ...
        if spec:
            ...
            if (risk_score >= 65 and adp <= (xrank + 6)) or (risk_score >= 80 and adp <= 160):
                ...
                action_advice = f"Carrying an elevated {risk_level} injury risk profile ({risk_score}/100: {c_res['clinical_diagnosis']}) without sufficient market discount (Real-Time ADP #{adp} vs xrank #{xrank}). Prefer healthier tier alternatives."
            ...
            elif pos in ["RB", "FLEX"] and (adp <= 140 or xrank <= 140):
                category = "HANDCUFF"
                ...
                action_advice = f"Clean clinical medical baseline with standard practice participation on {official_pfn_team}. Solid building block at xrank #{xrank} / Real-Time ADP #{adp}."
    ...
    handcuff_matrix = [
        ...
        },
        {
            ...
            "handcuff": "Jonathon Brooks / Trevor Etienne", "adp_target": "Round 7-8 (Brooks Starter)",
        ...
        },
        {
            ...
            "handcuff": "Jordan James / Isaac Guerendo", "adp_target": "Round 11-12 (James)",
        ...
        },
        {
            ...
            "handcuff": "Tank Bigsby / Will Shipley", "adp_target": "Round 11-12 (Bigsby)",
        ...
        },
        {
            ...
            "handcuff": "Blake Corum / Jarquez Hunter", "adp_target": "Round 7-8 (Corum)",
        ...
        },
        {
            ...
            "handcuff": "Braelon Allen / Isaiah Davis", "adp_target": "Round 13-14 (Allen)",
        ...
        },
        {
            ...
            "handcuff": "Jaylen Wright / Ollie Gordon II", "adp_target": "Late Stash (Wright)",
        ...
        },
        {
            ...
            "handcuff": "MarShawn Lloyd / Chris Brooks", "adp_target": "Round 11-12 (Lloyd)",
        ...
        },
        {
            ...
            "handcuff": "Kyle Monangai / Roschon Johnson", "adp_target": "Round 13-14 (Monangai)",
        ...
        },
        {
            ...
            "handcuff": "Jordan Mason / Zavier Scott", "adp_target": "Round 8-9 (Mason)",
